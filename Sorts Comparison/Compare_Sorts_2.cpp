...
void Menu()
{
     ...
     {
     case 1:
          if (modefill == 1) {Log = fopen ("Save\\Incr\\Incr-Sele.txt", "r");}
          if (modefill == 2) {Log = fopen ("Save\\Decr\\Decr-Sele.txt", "r");}
          if (modefill == 3) {Log = fopen ("Save\\Rnm5\\Rnm5-Sele.txt", "r");}
          if (modefill == 4) {Log = fopen ("Save\\Rndm\\Rndm-Sele.txt", "r");}
          break;
          
     case 2:
          if (modefill == 1) {Log = fopen ("Save\\Incr\\Incr-Bubb.txt", "r");}
          if (modefill == 2) {Log = fopen ("Save\\Decr\\Decr-Bubb.txt", "r");}
          if (modefill == 3) {Log = fopen ("Save\\Rnm5\\Rnm5-Bubb.txt", "r");}
          if (modefill == 4) {Log = fopen ("Save\\Rndm\\Rndm-Bubb.txt", "r");}
          break;
     
     case 3:
          if (modefill == 1) {Log = fopen ("Save\\Incr\\Incr-Shak.txt", "r");}
          if (modefill == 2) {Log = fopen ("Save\\Decr\\Decr-Shak.txt", "r");}
          if (modefill == 3) {Log = fopen ("Save\\Rnm5\\Rnm5-Shak.txt", "r");}
          if (modefill == 4) {Log = fopen ("Save\\Rndm\\Rndm-Shak.txt", "r");}
          break;
          
     case 4:
          if (modefill == 1) {Log = fopen ("Save\\Incr\\Incr-SiIn.txt", "r");}
          if (modefill == 2) {Log = fopen ("Save\\Decr\\Decr-SiIn.txt", "r");}
          if (modefill == 3) {Log = fopen ("Save\\Rnm5\\Rnm5-SiIn.txt", "r");}
          if (modefill == 4) {Log = fopen ("Save\\Rndm\\Rndm-SiIn.txt", "r");}
          break;
          
     case 5:
          if (modefill == 1) {Log = fopen ("Save\\Incr\\Incr-BiIn.txt", "r");}
          if (modefill == 2) {Log = fopen ("Save\\Decr\\Decr-BiIn.txt", "r");}
          if (modefill == 3) {Log = fopen ("Save\\Rnm5\\Rnm5-BiIn.txt", "r");}
          if (modefill == 4) {Log = fopen ("Save\\Rndm\\Rndm-BiIn.txt", "r");}
          break;
          
     case 6:
          if (modefill == 1) {Log = fopen ("Save\\Incr\\Incr-Quic.txt", "r");}
          if (modefill == 2) {Log = fopen ("Save\\Decr\\Decr-Quic.txt", "r");}
          if (modefill == 3) {Log = fopen ("Save\\Rnm5\\Rnm5-Quic.txt", "r");}
          if (modefill == 4) {Log = fopen ("Save\\Rndm\\Rndm-Quic.txt", "r");}
          break;
          
     case 7:
          if (modefill == 1) {Log = fopen ("Save\\Incr\\Incr-Heap.txt", "r");}
          if (modefill == 2) {Log = fopen ("Save\\Decr\\Decr-Heap.txt", "r");}
          if (modefill == 3) {Log = fopen ("Save\\Rnm5\\Rnm5-Heap.txt", "r");}
          if (modefill == 4) {Log = fopen ("Save\\Rndm\\Rndm-Heap.txt", "r");}
          break;
          
     case 8:
          if (modefill == 1) {Log = fopen ("Save\\Incr\\Incr-Merg.txt", "r");}
          if (modefill == 2) {Log = fopen ("Save\\Decr\\Decr-Merg.txt", "r");}
          if (modefill == 3) {Log = fopen ("Save\\Rnm5\\Rnm5-Merg.txt", "r");}
          if (modefill == 4) {Log = fopen ("Save\\Rndm\\Rndm-Merg.txt", "r");}
          break;
     }
