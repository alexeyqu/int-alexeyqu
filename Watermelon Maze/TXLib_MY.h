...
enum txColors {
    ...
    txMAN          = RGB (  1,   1,   1), TX_MAN           = txMAN, 
    txBLUE         = RGB (  0,   0, 128), TX_BLUE          = txBLUE,         //!< Синий цвет
    txWALLS        = RGB (112, 165,  85), TX_WALLS         = txWALLS,
    txWALLS1       = RGB (255, 242,   0), TX_WALLS1         = txWALLS1,
    txDARKGREEN    = RGB (  0, 128,   0), TX_DGREEN        = txDARKGREEN,
    txGREEN        = RGB (  0, 255,   0), TX_GREEN         = txGREEN,        //!< Зеленый цвет
    txCYAN         = RGB (  0, 128, 128), TX_CYAN          = txCYAN,         //!< Бирюзовый цвет
    txRED          = RGB (255,   0,   0), TX_RED           = txRED,          //!< Красный цвет
    ...
    txYELLOWEXIT   = RGB (255, 245,   6), TX_YELLOWEXIT    = txYELLOWEXIT, 
